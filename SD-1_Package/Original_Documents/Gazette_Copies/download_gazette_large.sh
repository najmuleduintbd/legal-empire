...
echo "[1/7] Calcutta Gazette (comprehensive volume)..."
...
echo "[2/7] Calcutta Gazette 1885 Jul-Dec (Bengal Tenancy Act)..."
...
echo "[3/7] Calcutta Gazette 1886 Apr-May (Tenancy Rules implementation)..."
...
echo "[4/7] Calcutta Gazette 1890 Jan-Jun..."
...
echo "[5/7] Calcutta Gazette 1910 Apr-Jun..."
...
echo "[6/7] Calcutta Gazette 1920 Apr-Jun..."
...
echo "[7/7] Calcutta Gazette 1937 Jan-Feb (GoI Act 1935 rules)..."
...
for f in "$DIR/Calcutta_Gazette_13339.pdf" \
         ...
         "$DIR/Calcutta_Gazette_1937_Jan-Feb.pdf"; do
  if [ -f "$f" ]; then
    sz=$(wc -c < "$f")
